...
class Graph:
    ...
    def construct_mst(self):
        ...
        # S = set of vertices in MST                                                                                                                                                              
        in_mst = [False] * n                                                                                                                                                                                                       
                                                                                                                                                                                                                                    
        # pi[v] = cost of cheapest known edge between v and S                                                                                                                                                                       
        pi = [float('inf')] * n                                                                                                                                                                                                                                                                                                                                                                                                                     
        # pred[v] = predecessor vertex in S that connects to v                                                                                                                                                                     
        pred = [None] * n                                                                                                                                                                                                          
        ...
        while pq:                                                                                                                                                                                                                  
            ...
            # T ← T ∪ {pred[u]} - add edge to MST                                                                                                                                                                                  
            if pred[u] is not None:                                                                                                                                                                                                
                weight = self.adj_mat[u, pred[u]]                                                                                                                                                                                  
                self.mst[u, pred[u]] = weight                                                                                                                                                                                      
                self.mst[pred[u], u] = weight                                                                                                                                                                                      
